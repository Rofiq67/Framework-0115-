...
<div class="container mt-5">
    <div class="row">
        <div class="col-lg-8">
            <h1> Edit Tambah Mahasiswa </h1>
                <div class="card">
                    <div class="card-body">
                        <form class="mt-3" action="{{ url('/update/' . $data->nim) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
